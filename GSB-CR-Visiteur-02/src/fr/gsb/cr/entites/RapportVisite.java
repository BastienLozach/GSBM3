...
public class RapportVisite {
	...
	*/
	...
	@Override
	public String toString() {
		return "RapportVisite "+ numero + " du "+ String.format("%02d/%02d/%04d",
				dateVisite.get(GregorianCalendar.DAY_OF_MONTH),
				dateVisite.get(GregorianCalendar.MONTH +1),
				dateVisite.get(GregorianCalendar.YEAR)
				) ;
